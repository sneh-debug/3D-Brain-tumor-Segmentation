...
def run_validation_case(data_index, output_dir, model, data_file, training_modalities,
    ...
    #for i, modality in enumerate(training_modalities):
     #   image = nib.Nifti1Image(test_data[0, i], affine)
      #  image.to_filename(os.path.join(output_dir, "data_{0}.nii.gz".format(modality))) #quoted to not write other modality in prediction folder, only truth and prediction files
