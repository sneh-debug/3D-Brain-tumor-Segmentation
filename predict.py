...
from train import config, fetch_brats_2020_files
...
def parse_args():
    ...
    parser.add_argument("--data_file", default="./BraTS2021_Validation_data.h5")
    parser.add_argument("--labels", nargs="*")
    parser.add_argument("--modalities", nargs="*")
    parser.add_argument("--validation_file", default="./BraTS2021_Validation_ids.pkl")
    parser.add_argument("--no_label_map", action="store_true", default=False)
    parser.add_argument("--prediction_dir", default="./BraTS2021_Validation_predictions")
